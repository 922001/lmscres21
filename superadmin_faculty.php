...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO faculty (name,registernumber,email,department,phonenumber,year,status,semester) 
VALUES ('$name','$rrn','$email','$department','$phonenumber','$year','unregistered',2)";
