        ...
        <div class="box-container">
            ...
            for ($index = 0; $index <= 2; $index++) {
              ...
              <div class='title'>
                ...
                echo "<a href='faculty_session.php?user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=1&semester=$semester'>
                <button>session 1</button></a>";
                echo "<a href='faculty_session.php?user_id=" . $user['id'] . "&subject_id=$subjectId&unit=$unitIndex&session=2&semester=$semester'>
