...
<html>
    ...
    <body> 
            ...
            <div class="container">
                ...
                <a href="question.php?n=1&semester=<?php echo $semester;?>&subject_id=<?php echo $subject_id;?>&session=<?php echo $session;?>&unit=<?php echo $unit;?>" class="btn btn-primary">take again</a>
